...
export class ExprParser extends Parser {
	...
	public static readonly _serializedATN: string =
		...
		"\x02\x04\x03\x02\x03\x04\x03\x02\x05\x06\x022\x02\r\x03\x02\x02\x02\x04" +
		...
		"\n\x06\x02\x16\x17\x07\f\x02\x02\x17\x07\x03\x02\x02\x02\x18\x19\x07\t" +
		"\x02\x02\x19\x1A\x07\v\x02\x02\x1A\x1B\x05\n\x06\x02\x1B\x1C\x07\f\x02" +
		"\x02\x1C\t\x03\x02\x02\x02\x1D\x1E\b\x06\x01\x02\x1E%\x07\n\x02\x02\x1F" +
		"%\x07\t\x02\x02 !\x07\x07\x02\x02!\"\x05\n\x06\x02\"#\x07\b\x02\x02#%" +
		"\x03\x02\x02\x02$\x1D\x03\x02\x02\x02$\x1F\x03\x02\x02\x02$ \x03\x02\x02" +
		"\x02%.\x03\x02\x02\x02&\'\f\x07\x02\x02\'(\t\x02\x02\x02(-\x05\n\x06\b" +
		")*\f\x06\x02\x02*+\t\x03\x02\x02+-\x05\n\x06\x07,&\x03\x02\x02\x02,)\x03" +
		"\x02\x02\x02-0\x03\x02\x02\x02.,\x03\x02\x02\x02./\x03\x02\x02\x02/\v" +
		"\x03\x02\x02\x020.\x03\x02\x02\x02\x07\x0F\x13$,.";
...
export class ExprStatContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return ExprParser.RULE_exprStat; }
	// @Override
	public enterRule(listener: ExprListener): void {
...
export class AssignStatContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return ExprParser.RULE_assignStat; }
	// @Override
	public enterRule(listener: ExprListener): void {
